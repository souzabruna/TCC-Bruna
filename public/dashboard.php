...
<input type="checkbox" id="check">
		...
		<ul class="NavBox">
			<li class="DivLink"> <i class="material-icons">receipt</i> Relatorios</li>
			<li class="DivLink"> <i class="material-icons">add_shopping_cart</i> Vendas</li>
			<li class="DivLink"> <i class="material-icons">person_add</i>Cadastros</li>
			...
			<div class="BoxDashboard">
				<div class="BoxMemories">
					...
					<div class="Column">
						...
						<i class="material-icons" style="font-size:2.5em; font-weight: bold;">add_shopping_cart</i>
						<span> Vender</span>
							
						</div>
						<div class="MemoriesGreen">
							 <i class="material-icons" style="font-size: 2.5em;">business_center</i>
							 <span>Montar Consignado</span>
							
						</div>
						<div class="MemoriesRed">
						<i class="material-icons" style="font-size: 2.5em">create</i>
					...
					<div class="Column">
						<div class="MemoriesBlue">
							...
							<i class="material-icons" style="font-size: 1.7em">attach_money</i>
							<span>Fluxo de caixa</span>
								
							</div>
							<div class="MemoriesSmall">
							<i class="material-icons" style="font-size: 1.7em">monetization_on</i>
							<span>Comissões</span>
				...
				<div class="Card">
					<div class= "CardTitle">
						 <div class="CardColor">
							<i class="material-icons" style="font-size: 1.5em; ">assessment</i>
				...
				<div class="Card">
					<div class= "CardTitle">
	                    <div class="CardColor">
							<i class="material-icons" style="font-size: 1.5em;">account_box</i>
